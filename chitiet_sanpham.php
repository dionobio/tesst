                                ...
                                <div class="product-large-slider">
                                    ...
                                    <div class="pro-large-img img-zoom">
                                        <a href="<?= BASE_URL . '?act=chi-tiet-san-pham&id=' . $Sanpham['id'] ?>">
                                            <img class="pri-img" src="<?= BASE_URL_IMG . $Sanpham['hinh_anh'] ?>"
                                                alt="product">
                                        </a>
                            ...
                            <div class="col-lg-7">
                                <div class="product-details-des">
                                    ...
                                    <div class="price-box">
                                        ...
                                        <span
                                            class="price-old"><del><?= formatPrice($Sanpham['gia_ban']) . 'đ'; ?></del></span>
                                        <?php } else { ?>
                                        <span
                                            class="price-regular"><?= formatPrice($Sanpham['gia_ban']) . 'đ'; ?></span>
                                        <?php } ?>
                                    ...
                                    <div class="container my-4">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">
                                                        <strong><?= htmlspecialchars($binhLuan['nguoi_binh_luan']) ?>:</strong>
                                            ...
                                            <form action="index.php?act=add-binhluan" method="POST" class="review-form">
                                                ...
                                                <!-- ID sản phẩm -->
                                                <!-- <input type="hidden" name="tai_khoan_id" value="<?= $_SESSION['user_id'] ?>"> ID tài khoản người dùng -->
                                            ...
                                            <?php /* else : ?>
                                            <!-- Nếu người dùng chưa đăng nhập, hiển thị thông báo và liên kết đến trang đăng nhập -->
                                            <p class="text-danger">Bạn cần đăng nhập để có thể bình luận.</p>
